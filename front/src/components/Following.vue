...
export default {
  ...
  mounted() {
    ...
    axios.get('https://i3b304.p.sns.io/api/follow/forFollowing',{
      params:{
      userName: this.name,
    }
    }).then((data) => {
      ...
      ARRAYFOLLOW.forEach((element,index) => {
        ...
        axios.get('https://i3b304.p.sns.io/api/isfollowed',{
          params:{
        ...
        FollowingBtn.addEventListener('click', () => {
          ...
          if (Action == 'following-follow-btn') {
            ...
            Num = data.data.object.followno
              ...
              axios.get('https://i3b304.p.sns.io/api/follow/delete',{
              params:{
                followNo: Num,
              }
              }).then(() => {
            ...
            .catch(
              ...
              axios.get('https://i3b304.p.sns.io/api/follow/add',{
                params:{
                  followedUser: element.followeduser,
                  followingUser: this.nick
                }
