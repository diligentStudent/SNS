...
export default {
  ...
  methods: {
    ...
    inUserSearch() {
      axios.get(`https://i3b304.p.sns.io/api/search/user`,{
      params: {
    ...
    infiniteHandler($state){
      let ref=this;
      axios.post('https://i3b304.p.sns.io/api/search/all/'+ref.limit)
      .then((data)=>{
        setTimeout(() => {
  ...
  mounted() {
    ...
    axios.post("https://i3b304.p.sns.io/api/search/all/0").then((data)=>{
