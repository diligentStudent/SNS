...
export default {
  ...
  methods: {
    ...
    goConfrim() {
      axios.get('https://i3b304.p.sns.io/api/account/confirmemail',{
        params:{
    ...
    checkNickname() {
      axios.get('https://i3b304.p.ssasnsfy.io/api/account/checkNickname',{ 
        params: {
    ...
    signupFinish() {
      ...
      axios.post('https://i3b304.p.sns.io/api/account/signup',{
      ...
      if (photoFile.files[0]) {
        ...
        axios.post('https://i3b304.p.sns.io/api/account/addProfileImg',frm,
        ).then( () =>{
      ...
      if (this.input.email.length >= 4 && EmailValidator.validate((this.input.email+'@'+this.input.url)))
        { 
         ...
         this.finalMail = false;
          if (this.mailSucMsg) {
            axios.get('https://i3b304.p.sns.io/api/account/checkDoubleEmail',{ 
              params: {
                email: this.input.email+'@'+this.input.url
                }
            }).then(data => {
