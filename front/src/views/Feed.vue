...
export default {
  ...
  methods: {
    ...
    getInflu() {
      axios.get("https://i3b304.p.sns.io/api/board/influencer").then((data)=>{
    ...
    clickLike(articleNo,flag,index,e) {
      ...
      if(flag==0){
        ...
        axios.post('https://i3b304.p.sns.io/api/board/likes',{
            articleNo:articleNo,
            nickname:res
          })
          .then()
        ...
        axios.delete('https://i3b304.p.sns.io/api/board/likes',{
          data:{
            articleNo:articleNo,
            nickname:res
          }
    ...
    clickBookMark(articleNo,flag,index,e) {
      ...
      if(flag==0){
        ...
        axios.post('https://i3b304.p.sns.io/api/board/bookmark',{
        ...
        axios.delete('https://i3b304.p.sns.io/api/board/bookmark',{
          data:{
            bookedArticle:articleNo,
            bookUser:res
          }
    ...
    infiniteHandler($state){
      ...
      axios.post('https://i3b304.p.sns.io/api/board/newsfeed/'+ref.limit,frm)
      .then((data)=>{
        setTimeout(() => {
          if(data.data.length){
            ...
            for (let index = 0; index < this.feedlist.length; index++) {
              ...
              axios.post("https://i3b304.p.sns.io/api/board/profileimg",follow).then((proff)=>{
              ...
              axios.post("https://i3b304.p.sns.io/api/board/images",articleNo).then((img)=>{
                const imgs = img.data;
                const imglist = [];
              ...
              axios.post("https://i3b304.p.sns.io/api/board/tags",articleNo).then((tag)=>{
              const tags = tag.data;
              const taglist = [];
  ...
  mounted() {
    ...
    axios.post('https://i3b304.p.sns.io/api/board/newsfeed/0',formData).then((data)=>{
      this.feedlist=data.data;
      for (let index = 0; index < this.feedlist.length; index++) {
        let feeddata={tags:[],
                      images:[],
