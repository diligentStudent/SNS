...
export default {
  ...
  methods: {
    ...
    deleteSearch() {
      ...
      axios.delete(`https://i3b304.p.sns.io/api/search/deleteSearchHistory/${nickname}`
      )
      .then(Swal.fire(
        '검색기록이 삭제되었습니다..',
        '새로운 검색을 입력해주세요!',
    ...
    deleteAllAlarm(){
      ...
      axios.post('https://i3b304.p.sns.io/api/alarm/del',frm
      )
      .then(Swal.fire(
        '알람기록이 삭제되었습니다..',
        '새로운 알람을 기대해주세요!',
    ...
    leave(){
      ...
      Swal.fire({
       ...
       .catch()
          axios.delete('https://i3b304.p.sns.io/api/account/delete',{
        data:formData,
      })
      .then((data)=>{
