...
export default {
  ...
  mounted(){
    ...
    this.nickname=res;
    axios.get('https://i3b304.p..io/api/mypage/',{
      params:{nickname:res}
    })
    .then((data)=>{
  ...
  methods: {
    ...
    cancel() {
      ...
      this.tempNickName=res;
      this.nickname=res;
      axios.get('https://i3b304.p.sns.io/api/mypage/',{
      params:{nickname:res}
      })
      .then((data)=>{
        ref.followedCnt=data.data.followedCnt;
    ...
    change() {
      ...
      axios.post('https://i3b304.p.sns.io/api/account/nickchange',formData)
      .then((data)=>{
    ...
    changeInput() {
      ...
      axios.put('https://i3b304.p.sns.io/api/account/selfintro',formData)
      .then((data)=>{
        ref.$cookies.set('auth-token', data.data.auth_token)
        ref.setToken(data.data.auth_token)
        ref.sendUserInfo();
